...
def display_image(title, image):
    ...
    plt.figure(figesize=(8, 8))
    if len(image.shape) ==2:
        plt.ishow(image, cmap='gray')
    else:
...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            combined_sobel = cv2.bitwise_or(sobelx.astype(np.uint8), sobely.astype)
...
interactive_edge_detection('C://Users//abigail.vandenbergh//Downloads//example.jpg')
